...
import {CardGridSliceBokaCard} from "../../../../../prismicio-types";
...
export type CardGridSliceBokaCardProps = {
    slice: Content.CardGridSliceBokaCard
};

const CardBokaCard = ({ slice }: CardGridSliceBokaCardProps): JSX.Element => {
